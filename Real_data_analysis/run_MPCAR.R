...
###########################
source("Real_data_analysis/functions/mpcar_bartlett.R") 
source("Real_data_analysis/functions/MCAR_single_covariate.R")  
...
if(!file.exists("Real_data_analysis/results")) dir.create("Real_data_analysis/results")

# Save the results
save(mpcar, mpcar.eigen64, mpcar.eigen59, mpcar.eigen54, mpcar.eigen49,
     file="Real_data_analysis/results/MPCAR_dowry_rapes_vs_sexratio_2011.Rdata")
