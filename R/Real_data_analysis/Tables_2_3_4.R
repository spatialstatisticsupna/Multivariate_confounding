...
# Load the results #
####################
load("R/Real_data_analysis/results/MICAR_dowry_rapes_vs_sexratio_2011.Rdata")
# load("R/Real_data_analysis/results/MPCAR_dowry_rapes_vs_sexratio_2011.Rdata")
# load("R/Real_data_analysis/results/MBYM2_dowry_rapes_vs_sexratio_2011.Rdata")
