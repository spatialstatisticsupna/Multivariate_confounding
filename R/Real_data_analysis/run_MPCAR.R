...
###########################
source("R/Real_data_analysis/functions/mpcar_bartlett.R") 
source("R/Real_data_analysis/functions/MCAR_single_covariate.R")  
...
############################
# Multivariate PCAR models #
############################
mpcar <- MCAR.Covariate(carto=carto_UP, data=data, ID.area="dist", ID.disease="Crime",
...
if(!file.exists("R/Real_data_analysis/results")) dir.create("R/Real_data_analysis/results")

# Save the results
save(mpcar, mpcar.eigen64, mpcar.eigen59, mpcar.eigen54, mpcar.eigen49,
     file="R/Real_data_analysis/results/MPCAR_dowry_rapes_vs_sexratio_2011.Rdata")
