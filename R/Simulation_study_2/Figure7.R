...
# MICAR
load("R/Simulation_study_2/results_Scenario1/MICAR_SexRatio_2df.Rdata")
load("R/Simulation_study_2/results_Scenario1/MICAR_SpatPlus_SexRatio_2df.Rdata")
...
# MPCAR
load("R/Simulation_study_2/results_Scenario1/MPCAR_SexRatio_2df.Rdata")
load("R/Simulation_study_2/results_Scenario1/MPCAR_SpatPlus_SexRatio_2df.Rdata")
...
# MBYM2
load("R/Simulation_study_2/results_Scenario1/MBYM2_SexRatio_2df.Rdata")
load("R/Simulation_study_2/results_Scenario1/MBYM2_SpatPlus_SexRatio_2df.Rdata")
...
# MICAR
load("R/Simulation_study_2/results_Scenario2/MICAR_SexRatio_2df.Rdata")
load("R/Simulation_study_2/results_Scenario2/MICAR_SpatPlus_SexRatio_2df.Rdata")
...
# MPCAR
load("R/Simulation_study_2/results_Scenario2/MPCAR_SexRatio_2df.Rdata")
load("R/Simulation_study_2/results_Scenario2/MPCAR_SpatPlus_SexRatio_2df.Rdata")
...
# MBYM2
load("R/Simulation_study_2/results_Scenario2/MBYM2_SexRatio_2df.Rdata")
load("R/Simulation_study_2/results_Scenario2/MBYM2_SpatPlus_SexRatio_2df.Rdata")
...
######################################################
# Figure 4: boxplot of the estimated means of beta 2 #
######################################################
pdf(file="Figure7.pdf", width=14, height=8)
...
p <- ggplot(data, aes(x = model, y = beta, fill=prior)) + 
  ...
  scale_y_continuous(limits=c(0.05, 0.42), breaks=c(0.1,0.2,0.3,0.4))
