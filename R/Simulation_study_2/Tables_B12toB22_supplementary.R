...
# Load the results #
####################
load(paste0(spatial,"_SexRatio_2df.Rdata"))
load(paste0(spatial,"_SpatPlus_SexRatio_2df.Rdata"))
...
MSpatPlus44 <- micar.bart.eigen44
MSpatPlus39 <- micar.bart.eigen39
...
# MSpatPlus44 <- mpcar.bart.eigen44
# MSpatPlus39 <- mpcar.bart.eigen39
...
# MSpatPlus44 <- mbym2.bart.eigen44
# MSpatPlus39 <- mbym2.bart.eigen39



############################################################################
# Table B12: posterior median and 95% CI of the correlation between crimes #
############################################################################
...
SpatPlus44.cor <- rbind(apply(do.call(rbind, lapply(MSpatPlus44, cor.crimes)), 2, mean))
SpatPlus39.cor <- rbind(apply(do.call(rbind, lapply(MSpatPlus39, cor.crimes)), 2, mean))


Tab.cor <- rbind(Spat.cor, SpatPlus64.cor, SpatPlus59.cor, SpatPlus54.cor, SpatPlus49.cor,
                 SpatPlus44.cor, SpatPlus39.cor)
Tab.cor <- as.data.frame(Tab.cor)
rownames(Tab.cor) <- c("M-Spatial", "M-SpatPlus64", "M-SpatPlus59", "M-SpatPlus54", 
                       "M-SpatPlus49", "M-SpatPlus44", "M-SpatPlus39")
...
#############################################
# Table B13: posterior mean and sd of beta1 #
#############################################
beta1 <- function(x){
...
SpatPlus44.beta1 <- rbind(apply(do.call(rbind, lapply(MSpatPlus44, beta1)), 2, mean))
SpatPlus39.beta1 <- rbind(apply(do.call(rbind, lapply(MSpatPlus39, beta1)), 2, mean))


Tab.beta1 <- rbind(Spat.beta1, SpatPlus64.beta1, SpatPlus59.beta1, SpatPlus54.beta1, 
                   SpatPlus49.beta1, SpatPlus44.beta1, SpatPlus39.beta1)
Tab.beta1 <- as.data.frame(Tab.beta1)
rownames(Tab.beta1) <- c("M-Spatial", "M-SpatPlus64", "M-SpatPlus59", "M-SpatPlus54", 
                         "M-SpatPlus49", "M-SpatPlus44", "M-SpatPlus39")
...
#############################################
# Table B14: posterior mean and sd of beta2 #
#############################################
beta2 <- function(x){
...
SpatPlus44.beta2 <- rbind(apply(do.call(rbind, lapply(MSpatPlus44, beta2)), 2, mean))
SpatPlus39.beta2 <- rbind(apply(do.call(rbind, lapply(MSpatPlus39, beta2)), 2, mean))


Tab.beta2 <- rbind(Spat.beta2, SpatPlus64.beta2, SpatPlus59.beta2, SpatPlus54.beta2, 
                   SpatPlus49.beta2, SpatPlus44.beta2, SpatPlus39.beta2)
Tab.beta2 <- as.data.frame(Tab.beta2)
rownames(Tab.beta2) <- c("M-Spatial", "M-SpatPlus64", "M-SpatPlus59", "M-SpatPlus54", 
                         "M-SpatPlus49", "M-SpatPlus44", "M-SpatPlus39")
...
################################################################
# Table B15: estimated and simulated standard errors for beta1 #
################################################################
...
Tab.est.beta1 <- data.frame(Spat=est.beta1(MSpat),
                            ...
                            SpatPlus44=est.beta1(MSpatPlus44),
                            SpatPlus39=est.beta1(MSpatPlus39))
colnames(Tab.est.beta1) <- c("M-Spatial", "M-SpatPlus64", "M-SpatPlus59", "M-SpatPlus54", 
                             "M-SpatPlus49", "M-SpatPlus44", "M-SpatPlus39")
...
Tab.sim.beta1 <- data.frame(Spat=sim.beta1(MSpat),
                            ...
                            SpatPlus44=sim.beta1(MSpatPlus44),
                            SpatPlus39=sim.beta1(MSpatPlus39))
colnames(Tab.sim.beta1) <- c("M-Spatial", "M-SpatPlus64", "M-SpatPlus59", "M-SpatPlus54", 
                             "M-SpatPlus49", "M-SpatPlus44", "M-SpatPlus39")
...
################################################################
# Table B16: estimated and simulated standard errors for beta2 #
################################################################
...
Tab.est.beta2 <- data.frame(Spat=est.beta2(MSpat),
                            ...
                            SpatPlus44=est.beta2(MSpatPlus44),
                            SpatPlus39=est.beta2(MSpatPlus39))
colnames(Tab.est.beta2) <- c("M-Spatial", "M-SpatPlus64", "M-SpatPlus59", "M-SpatPlus54", 
                             "M-SpatPlus49", "M-SpatPlus44", "M-SpatPlus39")
...
Tab.sim.beta2 <- data.frame(Spat=sim.beta2(MSpat),
                            ...
                            SpatPlus44=sim.beta2(MSpatPlus44),
                            SpatPlus39=sim.beta2(MSpatPlus39))
colnames(Tab.sim.beta2) <- c("M-Spatial", "M-SpatPlus64", "M-SpatPlus59", "M-SpatPlus54", 
                             "M-SpatPlus49", "M-SpatPlus44", "M-SpatPlus39")
...
#####################################################################
# Table B17a: 95% coverage probabilities of the true value of beta1 #
#####################################################################
real.beta1 <- 0.15
...
Coverage.beta1 <- data.frame(Spat=mean(unlist(lapply(MSpat, function(x) Coverage.beta1(x,real.beta1))))*100,
                             ...
                             SpatPlus44=mean(unlist(lapply(MSpatPlus44, function(x) Coverage.beta1(x,real.beta1))))*100,
                             SpatPlus39=mean(unlist(lapply(MSpatPlus39, function(x) Coverage.beta1(x,real.beta1))))*100)   


Coverage.beta1 <- as.data.frame(t(Coverage.beta1))
Coverage.beta1[, 1] <- round(Coverage.beta1[, 1], 4)
rownames(Coverage.beta1) <- c("M-Spatial", "M-SpatPlus64", "M-SpatPlus59", "M-SpatPlus54", 
                              "M-SpatPlus49", "M-SpatPlus44", "M-SpatPlus39")
...
#####################################################################
# Table B17b: 95% coverage probabilities of the true value of beta2 #
#####################################################################
real.beta2 <- 0.2
...
Coverage.beta2 <- data.frame(Spat=mean(unlist(lapply(MSpat, function(x) Coverage.beta2(x,real.beta2))))*100,
                             ...
                             SpatPlus44=mean(unlist(lapply(MSpatPlus44, function(x) Coverage.beta2(x,real.beta2))))*100,
                             SpatPlus39=mean(unlist(lapply(MSpatPlus39, function(x) Coverage.beta2(x,real.beta2))))*100)   


Coverage.beta2 <- as.data.frame(t(Coverage.beta2))
Coverage.beta2[, 1] <- round(Coverage.beta2[, 1], 4)
rownames(Coverage.beta2) <- c("M-Spatial", "M-SpatPlus64", "M-SpatPlus59", "M-SpatPlus54", 
                              "M-SpatPlus49", "M-SpatPlus44", "M-SpatPlus39")
...
#########################################
# Table B18: DIC and WAIC of the models #
#########################################
DIC.WAIC <- function(x){
...
SpatPlus44.dic.waic <- rbind(apply(do.call(rbind, lapply(MSpatPlus44, DIC.WAIC)), 2, mean))
SpatPlus39.dic.waic <- rbind(apply(do.call(rbind, lapply(MSpatPlus39, DIC.WAIC)), 2, mean))


Tab.DIC.WAIC <- rbind(Spat.dic.waic, SpatPlus64.dic.waic, SpatPlus59.dic.waic, SpatPlus54.dic.waic, 
                      SpatPlus49.dic.waic, SpatPlus44.dic.waic, SpatPlus39.dic.waic)
Tab.DIC.WAIC <- as.data.frame(Tab.DIC.WAIC)
rownames(Tab.DIC.WAIC) <- c("M-Spatial", "M-SpatPlus64", "M-SpatPlus59", "M-SpatPlus54", 
                            "M-SpatPlus49", "M-SpatPlus44", "M-SpatPlus39")
...
####################################################
# Table B19: MARB and MRRMSE of the relative risks #
####################################################
...
setwd("")
load("Simulated_data/SimuStudy2_Scenario4.Rdata")
...
RR.SpatPlus44 <- lapply(MSpatPlus44, function(x) matrix(x$summary.fitted.values$'0.5quant',140,1))
RR.SpatPlus39 <- lapply(MSpatPlus39, function(x) matrix(x$summary.fitted.values$'0.5quant',140,1))
...
MARB <- data.frame(Spat=MARB.RR(RR.Spat),
                   ...
                   SpatPlus44=MARB.RR(RR.SpatPlus44),
                   SpatPlus39=MARB.RR(RR.SpatPlus39))


colnames(MARB) <- c("M-Spatial", "M-SpatPlus64", "M-SpatPlus59", "M-SpatPlus54", 
                    "M-SpatPlus49", "M-SpatPlus44", "M-SpatPlus39")
...
MRRMSE <- data.frame(Spat=MRRMSE.RR(RR.Spat),
                     ...
                     SpatPlus44=MRRMSE.RR(RR.SpatPlus44),
                     SpatPlus39=MRRMSE.RR(RR.SpatPlus39))


colnames(MRRMSE) <- c("M-Spatial", "M-SpatPlus64", "M-SpatPlus59", "M-SpatPlus54", 
                      "M-SpatPlus49", "M-SpatPlus44", "M-SpatPlus39")
...
#################################################################
# Table B20: length of 95% credible intervals of beta1 and beta2 # 
#################################################################
...
Length.beta1 <- data.frame(Spat=mean(unlist(lapply(MSpat, function(x) Length.beta1(x)))),
                           ...
                           SpatPlus44=mean(unlist(lapply(MSpatPlus44, function(x) Length.beta1(x)))),
                           SpatPlus39=mean(unlist(lapply(MSpatPlus39, function(x) Length.beta1(x)))))   

Length.beta1 <- as.data.frame(t(Length.beta1))
rownames(Length.beta1) <- c("M-Spatial", "M-SpatPlus64", "M-SpatPlus59", "M-SpatPlus54", 
                            "M-SpatPlus49", "M-SpatPlus44", "M-SpatPlus39")
...
Length.beta2 <- data.frame(Spat=mean(unlist(lapply(MSpat, function(x) Length.beta2(x)))),
                           ...
                           SpatPlus44=mean(unlist(lapply(MSpatPlus44, function(x) Length.beta2(x)))),
                           SpatPlus39=mean(unlist(lapply(MSpatPlus39, function(x) Length.beta2(x)))))   

Length.beta2 <- as.data.frame(t(Length.beta2))
rownames(Length.beta2) <- c("M-Spatial", "M-SpatPlus64", "M-SpatPlus59", "M-SpatPlus54", 
                            "M-SpatPlus49", "M-SpatPlus44", "M-SpatPlus39")
...
#######################################
# Table B21: MARB and MRRMSE of beta1 #
#######################################
real.beta1 <- 0.15
...
beta1.SpatPlus44 <- lapply(MSpatPlus44, beta1.mean)
beta1.SpatPlus39 <- lapply(MSpatPlus39, beta1.mean)
...
MARB.beta1 <- data.frame(Spat=MARB.beta1(beta1.Spat),
                         ...
                         SpatPlus44=MARB.beta1(beta1.SpatPlus44),
                         SpatPlus39=MARB.beta1(beta1.SpatPlus39))


colnames(MARB.beta1) <- c("M-Spatial", "M-SpatPlus64", "M-SpatPlus59", "M-SpatPlus54", 
                          "M-SpatPlus49", "M-SpatPlus44", "M-SpatPlus39")
...
MRRMSE.beta1 <- data.frame(Spat=MRRMSE.beta1(beta1.Spat),
                           ...
                           SpatPlus44=MRRMSE.beta1(beta1.SpatPlus44),
                           SpatPlus39=MRRMSE.beta1(beta1.SpatPlus39))


colnames(MRRMSE.beta1) <- c("M-Spatial", "M-SpatPlus64", "M-SpatPlus59", "M-SpatPlus54", 
                            "M-SpatPlus49", "M-SpatPlus44", "M-SpatPlus39")
...
#######################################
# Table B22: MARB and MRRMSE of beta2 #
#######################################
real.beta2 <- 0.2
...
beta2.SpatPlus44 <- lapply(MSpatPlus44, beta2.mean)
beta2.SpatPlus39 <- lapply(MSpatPlus39, beta2.mean)
...
MARB.beta2 <- data.frame(Spat=MARB.beta2(beta2.Spat),
                         ...
                         SpatPlus44=MARB.beta2(beta2.SpatPlus44),
                         SpatPlus39=MARB.beta2(beta2.SpatPlus39))


colnames(MARB.beta2) <- c("M-Spatial", "M-SpatPlus64", "M-SpatPlus59", "M-SpatPlus54", 
                          "M-SpatPlus49", "M-SpatPlus44", "M-SpatPlus39")
...
MRRMSE.beta2 <- data.frame(Spat=MRRMSE.beta2(beta2.Spat),
                           ...
                           SpatPlus44=MRRMSE.beta2(beta2.SpatPlus44),
                           SpatPlus39=MRRMSE.beta2(beta2.SpatPlus39))


colnames(MRRMSE.beta2) <- c("M-Spatial", "M-SpatPlus64", "M-SpatPlus59", "M-SpatPlus54", 
                            "M-SpatPlus49", "M-SpatPlus44", "M-SpatPlus39")
