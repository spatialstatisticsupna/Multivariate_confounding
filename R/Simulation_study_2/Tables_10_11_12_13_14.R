...
###########################################################################
# Table 10: posterior median and 95% CI of the correlation between crimes #
###########################################################################
...
############################################
# Table 11: posterior mean and sd of beta1 #
############################################
beta1 <- function(x){
...
############################################
# Table 12: posterior mean and sd of beta2 #
############################################
beta2 <- function(x){
...
####################################################################
# Table 13a: 95% coverage probabilities of the true value of beta1 #
####################################################################
real.beta1 <- 0.15
...
####################################################################
# Table 13b: 95% coverage probabilities of the true value of beta2 #
####################################################################
real.beta2 <- 0.2
...
########################################
# Table 14: DIC and WAIC of the models #
########################################
DIC.WAIC <- function(x){
