...
for (i in 1:n.sim){
  print(i)
  load(paste0("results_", scenario, "/MICAR_Spat_", i, ".Rdata"))
  micar.bart[[i]] <- micar.spat
}

save(micar.bart, file=paste0("results_", scenario, "/MICAR_SexRatio_2df.Rdata"))
...
for (i in 1:n.sim){
  print(i)
  load(paste0("results_", scenario, "/MICAR_SpatPlus_", i, ".Rdata"))
...
save(micar.bart.eigen64, micar.bart.eigen59, micar.bart.eigen54, micar.bart.eigen49,
     ...
     file=paste0("results_", scenario, "/MICAR_SpatPlus_SexRatio_2df.Rdata"))
...
for (i in 1:n.sim){
  print(i)
  load(paste0("results_", scenario, "/MPCAR_Spat_", i, ".Rdata"))
  mpcar.bart[[i]] <- mpcar.spat
}

save(mpcar.bart, file=paste0("results_", scenario, "/MPCAR_SexRatio_2df.Rdata"))
...
for (i in 1:n.sim){
  print(i)
  load(paste0("results_", scenario, "/MPCAR_SpatPlus_", i, ".Rdata"))
...
save(mpcar.bart.eigen64, mpcar.bart.eigen59, mpcar.bart.eigen54, mpcar.bart.eigen49, 
     ...
     file=paste0("results_", scenario, "/MPCAR_SpatPlus_SexRatio_2df.Rdata"))
...
for (i in 1:n.sim){
  print(i)
  load(paste0("results_", scenario, "/MBYM2_Spat_", i, ".Rdata"))
  mbym2.bart[[i]] <- mbym2.spat
}

save(mbym2.bart, file=paste0("results_", scenario, "/MBYM2_SexRatio_2df.Rdata"))
...
for (i in 1:n.sim){
  print(i)
  load(paste0("results_", scenario, "/MBYM2_SpatPlus_", i, ".Rdata"))
...
save(mbym2.bart.eigen64, mbym2.bart.eigen59, mbym2.bart.eigen54, mbym2.bart.eigen49, 
     ...
     file=paste0("results_", scenario, "/MBYM2_SpatPlus_SexRatio_2df.Rdata"))
