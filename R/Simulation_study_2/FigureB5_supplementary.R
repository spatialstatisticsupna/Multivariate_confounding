...
# MICAR
load("R/Simulation_study_2/results_Scenario3/MICAR_SexRatio_2df.Rdata")
load("R/Simulation_study_2/results_Scenario3/MICAR_SpatPlus_SexRatio_2df.Rdata")
...
# MPCAR
load("R/Simulation_study_2/results_Scenario3/MPCAR_SexRatio_2df.Rdata")
load("R/Simulation_study_2/results_Scenario3/MPCAR_SpatPlus_SexRatio_2df.Rdata")
...
# MBYM2
load("R/Simulation_study_2/results_Scenario3/MBYM2_SexRatio_2df.Rdata")
load("R/Simulation_study_2/results_Scenario3/MBYM2_SpatPlus_SexRatio_2df.Rdata")
...
# MICAR
load("R/Simulation_study_2/results_Scenario4/MICAR_SexRatio_2df.Rdata")
load("R/Simulation_study_2/results_Scenario4/MICAR_SpatPlus_SexRatio_2df.Rdata")
...
# MPCAR
load("R/Simulation_study_2/results_Scenario4/MPCAR_SexRatio_2df.Rdata")
load("R/Simulation_study_2/results_Scenario4/MPCAR_SpatPlus_SexRatio_2df.Rdata")
...
# MBYM2
load("R/Simulation_study_2/results_Scenario4/MBYM2_SexRatio_2df.Rdata")
load("R/Simulation_study_2/results_Scenario4/MBYM2_SpatPlus_SexRatio_2df.Rdata")
...
# MICAR
load("R/Simulation_study_2/results_Scenario5/MICAR_SexRatio_2df.Rdata")
load("R/Simulation_study_2/results_Scenario5/MICAR_SpatPlus_SexRatio_2df.Rdata")
...
# MPCAR
load("R/Simulation_study_2/results_Scenario5/MPCAR_SexRatio_2df.Rdata")
load("R/Simulation_study_2/results_Scenario5/MPCAR_SpatPlus_SexRatio_2df.Rdata")
...
# MBYM2
load("R/Simulation_study_2/results_Scenario5/MBYM2_SexRatio_2df.Rdata")
load("R/Simulation_study_2/results_Scenario5/MBYM2_SpatPlus_SexRatio_2df.Rdata")
...
######################################################
pdf(file="FigureB5.pdf", width=14, height=8)
...
p <- ggplot(data, aes(x = model, y = beta, fill=prior)) + 
  ...
  scale_y_continuous(limits=c(0.03, 0.41), breaks=c(0.1,0.2,0.3,0.4))
