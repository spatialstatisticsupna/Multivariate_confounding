...
if (scenario=="Scenario3"){
  tmap_save(plot, file="FigureB4a.pdf", width=12, height=4)
}
if (scenario=="Scenario4"){
  tmap_save(plot, file="FigureB4b.pdf", width=12, height=4)
}
if (scenario=="Scenario5"){
  tmap_save(plot, file="FigureB4c.pdf", width=12, height=4)
}
