...
for (i in 1:n.sim){
  print(i)
  load(paste0("R/Simulation_study_1/results_Scenario", Scenario, "/MICAR_Spat_", i, ".Rdata"))
  micar.bart[[i]] <- micar.spat
}

save(micar.bart, file=paste0("R/Simulation_study_1/results_Scenario", Scenario, "/MICAR_SexRatio_2df.Rdata"))
...
for (i in 1:n.sim){
  print(i)
  load(paste0("R/Simulation_study_1/results_Scenario", Scenario, "/MICAR_SpatPlus_", i, ".Rdata"))
...
save(micar.bart.eigen64, micar.bart.eigen59, micar.bart.eigen54, micar.bart.eigen49,
     file=paste0("R/Simulation_study_1/results_Scenario", Scenario, "/MICAR_SpatPlus_SexRatio_2df.Rdata"))
...
for (i in 1:n.sim){
  print(i)
  load(paste0("R/Simulation_study_1/results_Scenario", Scenario, "/MPCAR_Spat_", i, ".Rdata"))
  mpcar.bart[[i]] <- mpcar.spat
}

save(mpcar.bart, file=paste0("R/Simulation_study_1/results_Scenario", Scenario, "/MPCAR_SexRatio_2df.Rdata"))
...
for (i in 1:n.sim){
  print(i)
  load(paste0("R/Simulation_study_1/results_Scenario", Scenario, "/MPCAR_SpatPlus_", i, ".Rdata"))
...
save(mpcar.bart.eigen64, mpcar.bart.eigen59, mpcar.bart.eigen54, mpcar.bart.eigen49, 
     file=paste0("R/Simulation_study_1/results_Scenario", Scenario, "/MPCAR_SpatPlus_SexRatio_2df.Rdata"))
...
for (i in 1:n.sim){
  print(i)
  load(paste0("R/Simulation_study_1/results_Scenario", Scenario, "/MBYM2_Spat_", i, ".Rdata"))
  mbym2.bart[[i]] <- mbym2.spat
}

save(mbym2.bart, file=paste0("R/Simulation_study_1/results_Scenario", Scenario, "/MBYM2_SexRatio_2df.Rdata"))
...
for (i in 1:n.sim){
  print(i)
  load(paste0("R/Simulation_study_1/results_Scenario", Scenario, "/MBYM2_SpatPlus_", i, ".Rdata"))
...
save(mbym2.bart.eigen64, mbym2.bart.eigen59, mbym2.bart.eigen54, mbym2.bart.eigen49, 
     file=paste0("R/Simulation_study_1/results_Scenario", Scenario, "/MBYM2_SpatPlus_SexRatio_2df.Rdata"))
