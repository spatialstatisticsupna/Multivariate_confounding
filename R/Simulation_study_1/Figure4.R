...
# MICAR
load("Simulation_study_1/results_Scenario1/MICAR_SexRatio_2df.Rdata")
load("Simulation_study_1/results_Scenario1/MICAR_SpatPlus_SexRatio_2df.Rdata")
...
# MPCAR
load("Simulation_study_1/results_Scenario1/MPCAR_SexRatio_2df.Rdata")
load("Simulation_study_1/results_Scenario1/MPCAR_SpatPlus_SexRatio_2df.Rdata")
...
# MBYM2
load("Simulation_study_1/results_Scenario1/MBYM2_SexRatio_2df.Rdata")
load("Simulation_study_1/results_Scenario1/MBYM2_SpatPlus_SexRatio_2df.Rdata")
...
# MICAR
load("Simulation_study_1/results_Scenario2/MICAR_SexRatio_2df.Rdata")
load("Simulation_study_1/results_Scenario2/MICAR_SpatPlus_SexRatio_2df.Rdata")
...
# MPCAR
load("Simulation_study_1/results_Scenario2/MPCAR_SexRatio_2df.Rdata")
load("Simulation_study_1/results_Scenario2/MPCAR_SpatPlus_SexRatio_2df.Rdata")
...
# MBYM2
load("Simulation_study_1/results_Scenario2/MBYM2_SexRatio_2df.Rdata")
load("Simulation_study_1/results_Scenario2/MBYM2_SpatPlus_SexRatio_2df.Rdata")
