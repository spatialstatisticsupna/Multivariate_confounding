...
# MICAR
load("R/Simulation_study_1/results_Scenario1/MICAR_SexRatio_2df.Rdata")
load("R/Simulation_study_1/results_Scenario1/MICAR_SpatPlus_SexRatio_2df.Rdata")
...
# MPCAR
load("R/Simulation_study_1/results_Scenario1/MPCAR_SexRatio_2df.Rdata")
load("R/Simulation_study_1/results_Scenario1/MPCAR_SpatPlus_SexRatio_2df.Rdata")
...
# MBYM2
load("R/Simulation_study_1/results_Scenario1/MBYM2_SexRatio_2df.Rdata")
load("R/Simulation_study_1/results_Scenario1/MBYM2_SpatPlus_SexRatio_2df.Rdata")
...
# MICAR
load("R/Simulation_study_1/results_Scenario2/MICAR_SexRatio_2df.Rdata")
load("R/Simulation_study_1/results_Scenario2/MICAR_SpatPlus_SexRatio_2df.Rdata")
...
# MPCAR
load("R/Simulation_study_1/results_Scenario2/MPCAR_SexRatio_2df.Rdata")
load("R/Simulation_study_1/results_Scenario2/MPCAR_SpatPlus_SexRatio_2df.Rdata")
...
# MBYM2
load("R/Simulation_study_1/results_Scenario2/MBYM2_SexRatio_2df.Rdata")
load("R/Simulation_study_1/results_Scenario2/MBYM2_SpatPlus_SexRatio_2df.Rdata")
...
p <- ggplot(data, aes(x = model, y = beta, fill=prior)) + 
  ...
  scale_y_continuous(limits=c(-0.42, -0.04), breaks=c(-0.4,-0.3,-0.2,-0.1))
