...
# MICAR
load("R/Simulation_study_1/results_Scenario3/MICAR_SexRatio_2df.Rdata")
load("R/Simulation_study_1/results_Scenario3/MICAR_SpatPlus_SexRatio_2df.Rdata")
...
# MPCAR
load("R/Simulation_study_1/results_Scenario3/MPCAR_SexRatio_2df.Rdata")
load("R/Simulation_study_1/results_Scenario3/MPCAR_SpatPlus_SexRatio_2df.Rdata")
...
# MBYM2
load("R/Simulation_study_1/results_Scenario3/MBYM2_SexRatio_2df.Rdata")
load("R/Simulation_study_1/results_Scenario3/MBYM2_SpatPlus_SexRatio_2df.Rdata")
...
data.Scenario3$line <- c(rep(-0.15,nrow(data.Scenario3)))
...
# MICAR
load("R/Simulation_study_1/results_Scenario4/MICAR_SexRatio_2df.Rdata")
load("R/Simulation_study_1/results_Scenario4/MICAR_SpatPlus_SexRatio_2df.Rdata")
...
# MPCAR
load("R/Simulation_study_1/results_Scenario4/MPCAR_SexRatio_2df.Rdata")
load("R/Simulation_study_1/results_Scenario4/MPCAR_SpatPlus_SexRatio_2df.Rdata")
...
# MBYM2
load("R/Simulation_study_1/results_Scenario4/MBYM2_SexRatio_2df.Rdata")
load("R/Simulation_study_1/results_Scenario4/MBYM2_SpatPlus_SexRatio_2df.Rdata")
...
data.Scenario4$line <- c(rep(-0.15,nrow(data.Scenario4)))
...
# MICAR
load("R/Simulation_study_1/results_Scenario5/MICAR_SexRatio_2df.Rdata")
load("R/Simulation_study_1/results_Scenario5/MICAR_SpatPlus_SexRatio_2df.Rdata")
...
# MPCAR
load("R/Simulation_study_1/results_Scenario5/MPCAR_SexRatio_2df.Rdata")
load("R/Simulation_study_1/results_Scenario5/MPCAR_SpatPlus_SexRatio_2df.Rdata")
...
# MBYM2
load("R/Simulation_study_1/results_Scenario5/MBYM2_SexRatio_2df.Rdata")
load("R/Simulation_study_1/results_Scenario5/MBYM2_SpatPlus_SexRatio_2df.Rdata")
...
data.Scenario5$line <- c(rep(-0.15,nrow(data.Scenario5)))
...
# MICAR
load("R/Simulation_study_1/results_Scenario6/MICAR_SexRatio_2df.Rdata")
load("R/Simulation_study_1/results_Scenario6/MICAR_SpatPlus_SexRatio_2df.Rdata")
...
# MPCAR
load("R/Simulation_study_1/results_Scenario6/MPCAR_SexRatio_2df.Rdata")
load("R/Simulation_study_1/results_Scenario6/MPCAR_SpatPlus_SexRatio_2df.Rdata")
...
# MBYM2
load("R/Simulation_study_1/results_Scenario6/MBYM2_SexRatio_2df.Rdata")
load("R/Simulation_study_1/results_Scenario6/MBYM2_SpatPlus_SexRatio_2df.Rdata")
...
###################################
# Scenario 6: prepare a dataframe #
###################################
model <- c(rep("M-Spatial", n.sim), rep("M-SpatPlus64", n.sim), rep("M-SpatPlus59", n.sim),
           rep("M-SpatPlus54", n.sim), rep("M-SpatPlus49", n.sim))
...
data.Scenario6 <- rbind(data.micar, data.mpcar, data.mbym2)
data.Scenario6$model <- factor(data.Scenario6$model, levels=c("M-Spatial", "M-SpatPlus64", 
                                                              "M-SpatPlus59", "M-SpatPlus54", "M-SpatPlus49"))
data.Scenario6$prior <- factor(data.Scenario6$prior, levels=c("MICAR", "MPCAR", "MBYM2"))
data.Scenario6$line <- c(rep(-0.15,nrow(data.Scenario6)))
data.Scenario6$scenario <- rep("Scenario 6", nrow(data.Scenario6))
...
#########################################
data <- rbind(data.Scenario3, data.Scenario4, data.Scenario5, data.Scenario6)
...
#######################################################
# Figure A2: boxplot of the estimated means of beta 1 #
#######################################################
pdf(file="FigureA2.pdf", width=14, height=8)
...
p <- ggplot(data, aes(x = model, y = beta, fill=prior)) + 
  ...
  scale_y_continuous(limits=c(-0.45, 0.05), breaks=c(-0.4,-0.3,-0.2,-0.1, 0.0))
